...
def get_response_jett(input_msg, history):
  ...
  {'role':'assistant', 'content':'Jett: Bruh chai been faded than a hoe sitting like on the table for 5 minutes'},
  {'role':'user', 'content':'Kate: I swear I put at least 3 pounds a day'},
  {'role':'assistant', 'content':"Jett: Why don't I have any of it though"},
  *history
  ]
